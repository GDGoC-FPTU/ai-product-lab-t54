...
Trong vai trò AI Product Engineer tại Vin Smart Future, tôi quét các quy trình vận hành bằng bốn lenses:

1. **Repetitive:** tác vụ lặp lại với quy tắc hoặc dữ liệu tương tự.
2. **Time-consuming:** tác vụ chiếm nhiều thời gian thủ công.
3. **AI-upgrade:** tác vụ hiện có nhưng chất lượng hoặc tốc độ có thể cải thiện bằng khả năng xử lý ngôn ngữ.
4. **Stakeholder Pain:** bottleneck tạo ra phàn nàn, chờ đợi hoặc áp lực cho khách hàng/nhân viên.

Tôi không mặc định rằng mọi pain point đều cần AI. Mỗi cơ hội được xem xét cùng phương án No AI, Rule-based, LLM Feature và Agent.
...
| Giả định | Cách kiểm chứng | Người cần phỏng vấn/dữ liệu | Tiêu chí tiếp tục |
|---|---|---|---|
| Workflow mất khoảng 15 phút | Time study tối thiểu 50 ca | Dispatcher, ticket log | Median ≥10 phút |
| Bước 3–4 là bottleneck | Đo thời gian theo từng bước | Screen recording/log thao tác đã được phép | Chiếm ≥50% tổng thời gian |
| API có đủ GPS/trạm/cổng | Data audit và API spike | Đội Fleet/Charging Platform | ≥95% field bắt buộc đầy đủ |
| HITL không tạo thêm chậm trễ | Shadow pilot | Dispatcher | Review median ≤30 giây |
| Rule pin dưới 5% phù hợp | Safety review | Fleet Safety/Operations | Được phê duyệt bằng văn bản |
